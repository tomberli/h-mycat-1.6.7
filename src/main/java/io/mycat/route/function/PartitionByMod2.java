 ...
 *
 */
public class PartitionByMod2 extends AbstractPartitionAlgorithm implements RuleAlgorithm  {
...
//		columnValue = NumberParseUtil.eliminateQoute(columnValue);
	...
	private static void hashTest()  {
		PartitionByMod2 hash=new PartitionByMod2();
		hash.setCount(11);
		hash.init();
...
//		hashTest();
		PartitionByMod2 partitionByMod = new PartitionByMod2();
